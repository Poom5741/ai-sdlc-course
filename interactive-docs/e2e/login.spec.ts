...
test.describe("Login page", () => {
  ...
  test("shows error message on invalid credentials (mocked)", async ({
    page,
  }) => {
  ...
  test("successful login redirects to dashboard for regular users", async ({
    page,
  }) => {
    await page.route("**/api/auth/login", async (route) => {
      await route.fulfill({
  ...
  test("successful login redirects to admin for admin users", async ({
    page,
  }) => {
    await page.route("**/api/auth/login", async (route) => {
      await route.fulfill({
  ...
  test("redirects to dashboard if already logged in as regular user", async ({
    page,
  }) => {
    await page.goto("/login");
